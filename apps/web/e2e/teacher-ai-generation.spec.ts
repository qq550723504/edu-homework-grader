...
test('teacher creates an ordered G7 M1/M2 plan and reaches its first candidate review workspace', async ({ page }) => {
  ...
  await page.getByLabel('课程目标').selectOption({
    label: 'E2E-AI-G7-M1-M2 · Solve Grade 7 arithmetic and expression questions.',
  })
  await page.getByTestId('question-type-M1-foundation-increment').click()
  await page.getByTestId('question-type-M2-stretch-increment').click()
