...
export interface GenerationDefaultChange { id: string; status: string; provider_name: string; model_version: string; prompt_version: string; prompt_template_fingerprint: string; request_reason: string; evaluation_summary?: { promotion_eligible?: boolean; record_count?: number; issue_count?: number; candidate_gate?: { violations?: unknown[] } } }
export interface GenerationDefaultSummary { current: { provider_name: string; model_version: string; prompt_version: string; prompt_template_fingerprint: string } | null; pending: GenerationDefaultChange[]; history: GenerationDefaultChange[] }
